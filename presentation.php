...
$donnees_salles = [
    '001' => [
        ...
        'oeuvres' => [
            [
                'nom'   => 'Bon profil',
                'photo' => 'images/oeuvres/bon-profil.jpg',
            ...
            [
                'nom'   => 'Antithèse',
                'photo' => 'images/oeuvres/antithese.jpg',
            ...
            [
                ...
                'photo' => 'images/oeuvres/beaute-hors-du-cadre.jpg',
    ...
    '021' => [
        ...
        'oeuvres' => [
            [
                'nom'   => 'Community',
                'photo' => 'images/Community.png',
                'desc'  => 'Description à venir.'
            ],
            [
                'nom'   => 'Distorsion',
                'photo' => 'images/Distortion.png',
    ...
    '002' => [
        ...
        'oeuvres' => [
            [
                'nom'   => 'Tapis Rouge',
                'photo' => 'images/oeuvres/tapis-rouge.jpg',
            ...
            [
                'nom'   => 'En Direct',
                'photo' => 'images/oeuvres/en-direct.jpg',
            ...
            [
                ...
                'photo' => 'images/oeuvres/ad-hd.jpg',
    ...
    '005' => [
        ...
        'oeuvres' => [
            ...
            [
                'nom'   => 'Œuvre 4',
                'photo' => 'images/oeuvres/oeuvre-4.jpg',
                'desc'  => 'Description à venir.'
            ],
        ]
    ],
  ...
  <?php foreach ($salle['oeuvres'] as $i => $oeuvre): ?>
    <div class="row-oeuvre <?php echo ($i % 2 != 0) ? 'reverse' : ''; ?>">
      ...
      <div class="texte-oeuvre">
        <h4><?php echo htmlspecialchars($oeuvre['nom']); ?></h4>
        <p><?php echo $oeuvre['desc']; ?></p>
      </div>

      <div class="oeuvre-visual"
           onclick="openLightbox('<?php echo $oeuvre['photo']; ?>', '<?php echo htmlspecialchars($oeuvre['nom']); ?>')">
        <img src="<?php echo $oeuvre['photo']; ?>"
             alt="<?php echo htmlspecialchars($oeuvre['nom']); ?>"
             onerror="this.parentElement.style.display='none'">
        <span class="badge-oeuvre"><?php echo htmlspecialchars($oeuvre['nom']); ?></span>
      </div>
